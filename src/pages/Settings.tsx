...
const Settings = () => {
            ...
            case 'audio':
                return (
                    <div className="space-y-6">
                        <section className="space-y-6 p-6 rounded-2xl bg-card border border-border/50">
                            ...
                            <div className="grid gap-6">
                                <div className="flex items-center justify-between p-4 rounded-xl bg-secondary/30">
                                    ...
                                    <select
                                        value={audioQuality}
                                        onChange={(e) => setSetting('audioQuality', e.target.value)}
                                        className="bg-background border-border rounded-lg px-4 py-2 text-sm font-medium focus:ring-2 focus:ring-primary outline-none transition-all cursor-pointer hover:bg-secondary/50"
                                    >
                        ...
                        <section className="space-y-6 p-6 rounded-2xl bg-card border border-border/50">
                            ...
                            <div className="space-y-8">
                                <div className="space-y-4">
                                    <div className="flex items-center justify-between">
                                        <label className="font-semibold">Crossfade</label>
                                    ...
                                    <p className="text-xs text-muted-foreground">
                                        Overlap songs for a smooth transition without silence.
                                    </p>
                                </div>
    ...
    return (
        <>
            ...
            <div className="container max-w-6xl mx-auto pb-20 px-4 sm:px-6">
